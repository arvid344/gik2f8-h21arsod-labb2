  ...
  switch (name) {
    ...
    case 'description': {
      ...
      if (value.length > 500) {
        ...
        validationMessage =
          "Får inte innehålla mer än 500 tecken.";
      }
      else if (value.length === 0) {
        dueDateValid = false;
        validationMessage = "skriv in datum i rätt format!.";
    ...
    case 'dueDate': {
      ...
      if (value.length === 0) {
        ...
        dueDateValid = false;
        validationMessage = "ange slutför senast";
      }
